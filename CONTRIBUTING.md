# Contributing to ci-flightstats

Contributions are welcome.
These contributions are made in the form of Issues or [Pull Requests](http://help.github.com/send-pull-requests/) on the [main repository](https://github.com/bvrignaud/ci-flightstats>) on GitHub.

Issues are a quick way to point out a bug. If you find a bug or documentation error then please check a few things first:
...
CodeIgniter recommends PHP 5.5 or newer to be used, so all code supplied must stick to this
requirement.
...
You must sign your work, certifying that you either wrote the work or otherwise have the right to pass it on to an open source project. git makes this trivial as you merely have to use `--signoff` on your commits to your ci-flightstats fork.
...
1. `git remote add ci-flightstats git://github.com/bvrignaud/ci-flightstats.git`
2. `git pull ci-flightstats develop`
